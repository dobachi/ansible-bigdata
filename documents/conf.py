# -*- coding: utf-8 -*-
#
# Ansible Hadoop Document documentation build configuration file, created by
...
html_title = 'Ansible playbooks to construct Hadoop environment'

# A shorter title for the navigation bar.  Default is the same as html_title.
#html_short_title = 'ansible-hadoop doc'
...
htmlhelp_basename = 'AnsibleHadoopDocumentdoc'
